...
Every image below is real pipeline output from one clip, regenerated by `scripts/readme-visuals.py`.

**Landscape in, portrait out.** The 9:16 crop follows whoever is speaking.

<p align="center"><img src="docs/visuals/landscape-to-portrait.png" width="720" alt="A 16:9 two-shot with the tracked crop outlined, and the resulting 9:16 frame"></p>

**Face tracking across a speaker change.** Audio says who's talking, recognition finds their face, mouth movement confirms it — and a real cut in the source is honoured immediately.

<p align="center"><img src="docs/visuals/face-tracking.gif" width="240" alt="Portrait crop following the speaker, then cutting to the other person"></p>

**Six caption styles.** Four animated (Pill, Impact, Beast, Karaoke — rendered with HyperFrames) and two static (Clean, Box).

<p align="center"><img src="docs/visuals/caption-styles.png" width="720" alt="The same frame rendered with each of the six caption styles"></p>

**Text stickers and logos.** Drop a PNG, drag it into place; pick a colour combo for text.

<p align="center">
  <img src="docs/visuals/text-sticker.png" width="220" alt="A red text sticker at the top of the frame">&nbsp;&nbsp;
  <img src="docs/visuals/logo-sticker.png" width="220" alt="A logo image sticker in the top-right corner">
</p>

**Managing the frame.** Everything above is set per export in one dialog — style, caption position and size, colours, presets you can save, and stickers — with a live preview you can drag on.

<p align="center">
  <img src="docs/visuals/export-dialog.png" width="720" alt="The Export dialog: portrait preview on the left, caption style carousel, position, size and colour controls on the right">
</p>
<p align="center">
  <img src="docs/visuals/export-dialog-stickers.png" width="720" alt="The Export dialog's Sticker tab: text sticker with colour combos, and a logo/image drop zone">
</p>
